...
public class SocialMediaController {
    ...
    public ResponseEntity<Message> createMesage(@RequestBody Message message){
    ...
    public ResponseEntity<Object> updateMessageText(@PathVariable Integer messageId, @RequestBody Message newMessage){
        return messageService.updateMessageText(messageId, newMessage);
    }
